/**
 * Design Tokens
 * Централизованные значения для цветов, типографики, отступов и других дизайн-систем
 */
...
export const boxShadow = {
  ...
  'glow-purple': '0 0 20px rgb(139 92 246 / 0.5)',
  'glow-neon': '0 0 20px rgb(0 245 255 / 0.6)',
} as const;
